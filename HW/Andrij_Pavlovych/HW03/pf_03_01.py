...
#   find and print the number of occurrences of the words
search_list = ['better', 'never', 'is']
for item in search_list:
    print('Number of occurences of \'{}\' is {}'.format(item, zen.count(item)))

# replace all occurrences of the symbol “i” with “&”
# and display all text in uppercase (all letters in uppercase)
print(zen.replace('i', '&').upper())