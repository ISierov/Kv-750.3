...
#  not the end, so he turned to you, his guru, to help him and asked you to prepare some function, which could
# change name of given class.
...
def class_name_changer(cls, new_name):
    if new_name.isalnum() and new_name[0].isupper and new_name[0].isalpha():
...
myObject = MyClass()
print(class_name_changer(MyClass, "UsefulClass"))
