...
zen_up = zen.upper()
# Printing how many timed does the words occur in text
print("Times the word \"better\" occurs:", zen_up.count('BETTER'))
print("Times the word \"never\" occurs:", zen_up.count('NEVER'))
print("Times the word \"is\" occurs:", zen_up.count('IS'))
# Printing text in uppercase
print(zen_up)
# Printing text replacing symbols
print(zen.replace("i","&"))