...
def reWidth ():
    WIDTH_DISPLAY = abs(COORD_X) + WIDTH_RECTANGLE
    return pygame.display.set_mode((WIDTH_DISPLAY, HEIGHT_DISPLAY), pygame.RESIZABLE)

def reHeight ():
    HEIGHT_DISPLAY = abs(COORD_Y) + HEIGHT_RECTANGLE
    return pygame.display.set_mode((WIDTH_DISPLAY, HEIGHT_DISPLAY), pygame.RESIZABLE)
